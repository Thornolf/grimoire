...
ActiveRecord::Schema[7.2].define(version: 2024_10_11_152724) do
  ...
  create_table "bounds", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["character_sheet_id"], name: "index_bounds_on_character_sheet_id"
  end
  ...
  create_table "notes", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["mission_id"], name: "index_notes_on_mission_id"
  ...
  add_foreign_key "notes", "missions"
